...
public class InitData {
    ...
    static class InitService {
        ...
        public void init() {
            ...
            Member member5 = new Member("loginId5", "password5", "test5", "별명5", 10, true, "010-1111-2222", BloodType.A_PLUS, "aaa@naver.com", "인천시", true);
            Member member6 = new Member("loginId6", "password6", "test6", "별명6", 20, false, "010-3333-4444", BloodType.B_PLUS, "bbb@naver.com", "인천시", true);
            Member member7 = new Member("loginId7", "password7", "test7", "별명7", 10, true, "010-1111-2222", BloodType.A_PLUS, "aaa@naver.com", "인천시", true);
            Member member8 = new Member("loginId8", "password8", "test8", "별명8", 20, false, "010-3333-4444", BloodType.B_PLUS, "bbb@naver.com", "인천시", true);
            Member member9 = new Member("loginId9", "password9", "test9", "별명9", 10, true, "010-1111-2222", BloodType.A_PLUS, "aaa@naver.com", "인천시", true);
            Member member10 = new Member("loginId10", "password10", "test10", "별명10", 20, false, "010-3333-4444", BloodType.B_PLUS, "bbb@naver.com", "인천시", true);
            for(int i = 0; i  < 14; i++) {
                member1.countPlus();
            }
            for(int i = 0; i  < 12; i++) {
